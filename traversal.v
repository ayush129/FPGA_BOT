...
module traversal(
	...
	accelvalid,  // to switch off/on the accelerometer
	where,			// debugging variable
...
reg [23:0] ddelay=500000; 			// bot detects the node in the very beginnig, because of which turning left/right to the next path becomes difficult, 
